...
import vasil.cardealer.models.binding.OfferAddModel;
import vasil.cardealer.models.service.OfferServiceModel;
import vasil.cardealer.models.view.OfferViewModel;
...
public class OfferController extends BaseController {
    ...
    @GetMapping("/my-offer")
    @PageTitle("My Offer")
    public ModelAndView myOffer(ModelAndView modelAndView, Principal principal) {
    ...
    @PreAuthorize("isAuthenticated()")
    @PageTitle("All Offer")
    public ModelAndView allOffer(ModelAndView modelAndView) {
    ...
    public ModelAndView deleteOffer(@PathVariable String id, ModelAndView modelAndView, @ModelAttribute(name = "offer") OfferAddModel offer) {
    ...
    public ModelAndView editOffer(@PathVariable String id, ModelAndView modelAndView, @ModelAttribute(name = "offer") OfferAddModel offer) {
        OfferServiceModel offerServiceModel = this.offerService.findById(id);
        offer = this.modelMapper.map(offerServiceModel, OfferAddModel.class);
    ...
    public ModelAndView handleOfferWithThisVehicleAlreadyExist(OfferWithThisVehicleAlreadyExistsException e) {
